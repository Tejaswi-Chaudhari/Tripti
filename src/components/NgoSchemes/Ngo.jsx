                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <prev class="card-text">For more information <a href="https://www.akshayapatra.org/" target="_blank">click here</a></prev>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <prev class="card-text">For more information <a href="https://www.feedingindia.org/"  target="_blank">click here</a></prev>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <prev class="card-text">For more information <a href="https://www.indiafoodbanking.org/" target="_blank">click here</a></prev>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <prev class="card-text">For more information <a href="https://mcksfood.com/" target="_blank">click here</a></prev>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <prev class="card-text">For more information <a href="https://www.smilefoundationindia.org/plate-half-full-uny/?utm_source=Google&utm_medium=Smart_ads&utm_campaign=hunger&utm_id=Unyscape&gclid=EAIaIQobChMIqpmq74i68wIVXJNmAh2PPAD5EAAYASAAEgIilfD_BwE" target="_blank">click here</a></prev>
                        </div>
                    </div>
                </div>
            </div>
